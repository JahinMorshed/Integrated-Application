...
class _QuizScreenState extends State<QuizScreen> {
  ...
  int quizTimeInSeconds = 1 * 60; // 5 minutes in seconds
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(
            255, 0, 150, 17), // Change the app bar color to black
        title: const Text('Quiz App'),
      ),
      body: Container(
        color: const Color.fromARGB(
            255, 11, 11, 11), // Change the background color to black
        child: Column(
          children: [
                ...
                itemBuilder: (context, index) {
                  ...
                  if (isSelected) {
                    backgroundColor = isCorrect
                        ? const Color.fromARGB(255, 47, 231, 53)
                        : Colors.red;
      ...
      bottomSheet: Container(
        ...
        color: const Color.fromARGB(255, 79, 6, 6),
        child: Row(
